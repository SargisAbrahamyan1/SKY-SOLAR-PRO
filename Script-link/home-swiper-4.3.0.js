...
! function(e, t) {
    ...
    var C = {
            ...
            passiveListeners: !0,
            containerModifierClass: "home_page_swiper-container-",
            slideClass: "home_page_swiper-slide",
            ...
            wrapperClass: "home_page_swiper-wrapper",
        ...
        A = {
            update: function(e) {
                ...
                }), t.$wrapperEl.children(".home_page_swiper-slide").css(v, y + "px"), x()
            },
    ...
    var B = {
        ...
        F = {
            ...
            onGestureStart: function(e) {
                ...
                a.$slideEl && a.$slideEl.length || (a.$slideEl = s(e.target).closest(".home_page_swiper-slide"), 0 === a.$slideEl.length && (a.$slideEl = this.slides.eq(this.activeIndex)), a.$imageEl = a.$slideEl.find("img, svg, canvas"), a.$imageWrapEl = a.$imageEl.parent("." + t.containerClass), a.maxRatio = a.$imageWrapEl.attr("data-swiper-zoom") || t.maxRatio, 0 !== a.$imageWrapEl.length) ? (a.$imageEl.transition(0), this.zoom.isScaling = !0) : a.$imageEl = void 0
            },
            ...
            enable: function() {
                ...
                if (!e.enabled) {
                    ...
                    h.gestures ? (this.$wrapperEl.on("gesturestart", ".home_page_swiper-slide", e.onGestureStart, t), this.$wrapperEl.on("gesturechange", ".home_page_swiper-slide", e.onGestureChange, t), this.$wrapperEl.on("gestureend", ".home_page_swiper-slide", e.onGestureEnd, t)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.on(this.touchEvents.start, ".home_page_swiper-slide", e.onGestureStart, t), this.$wrapperEl.on(this.touchEvents.move, ".home_page_swiper-slide", e.onGestureChange, t), this.$wrapperEl.on(this.touchEvents.end, ".home_page_swiper-slide", e.onGestureEnd, t)), this.$wrapperEl.on(this.touchEvents.move, "." + this.params.zoom.containerClass, e.onTouchMove)
                }
            },
            disable: function() {
                var e = this.zoom;
                if (e.enabled) {
                    ...
                    h.gestures ? (this.$wrapperEl.off("gesturestart", ".home_page_swiper-slide", e.onGestureStart, t), this.$wrapperEl.off("gesturechange", ".home_page_swiper-slide", e.onGestureChange, t), this.$wrapperEl.off("gestureend", ".home_page_swiper-slide", e.onGestureEnd, t)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.off(this.touchEvents.start, ".home_page_swiper-slide", e.onGestureStart, t), this.$wrapperEl.off(this.touchEvents.move, ".home_page_swiper-slide", e.onGestureChange, t), this.$wrapperEl.off(this.touchEvents.end, ".home_page_swiper-slide", e.onGestureEnd, t)), this.$wrapperEl.off(this.touchEvents.move, "." + this.params.zoom.containerClass, e.onTouchMove)
                }
            }
        },
        W = {
