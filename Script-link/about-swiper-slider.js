! function(e, t) {
    ...
    class J {
        ...
        getSlideIndex(e) {
            const {
                slidesEl: t,
                params: s
            } = this, a = b(f(t, `.${s.slideClass}, about-swiper-slide`)[0]);
            return b(e) - a
        }
        ...
        recalcSlides() {
            ...
            this.slides = f(e, `.${t.slideClass}, about-swiper-slide`)
        }
        enable() {
            const e = this;
        ...
        getSlideClasses(e) {
            const t = this;
            return t.destroyed ? "" : e.className.split(" ").filter((e => 0 === e.indexOf("about-swiper-slide") || 0 === e.indexOf(t.params.slideClass))).join(" ")
        }
        emitSlidesClasses() {
            const e = this;
            if (!e.params._emitClasses || !e.el) return;
    ...
    const pe = [function(e) {
        ...
        function d(e, t) {
            ...
            let i;
            return a.renderSlide ? (i = a.renderSlide.call(s, e, t), "string" == typeof i && (o.innerHTML = i, i = o.children[0])) : i = s.isElement ? g("about-swiper-slide") : g("div", s.params.slideClass), i.setAttribute("data-swiper-slide-index", t), a.renderSlide || (i.innerHTML = e), a.cache && (s.virtual.cache[t] = i), i
        }
        ...
        function c(e) {
            ...
            if (e) s.slidesEl.querySelectorAll(`.${s.params.slideClass}, about-swiper-slide`).forEach((e => {
                e.remove()
            }));
            else
                for (let e = c; e <= p; e += 1)
            ...
            f(s.slidesEl, ".about-swiper-slide, about-swiper-slide").forEach((e => {
                e.style[v] = x - Math.abs(s.cssOverflowAdjustment()) + "px"
            })), S()
        }
        r("beforeInit", (() => {
            ...
            if (void 0 === s.passedParams.virtual.slides) {
                const t = [...s.slidesEl.children].filter((e => e.matches(`.${s.params.slideClass}, about-swiper-slide`)));
        ...
        function d(e) {
            ...
            if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || l.activeElement && l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase()))) {
                if (t.params.keyboard.onlyInViewport && (d || c || p || u || m || h)) {
                    let e = !1;
                    if (y(t.el, `.${t.params.slideClass}, about-swiper-slide`).length > 0 && 0 === y(t.el, `.${t.params.slideActiveClass}`).length) return;
                    const a = t.el,
                        i = a.clientWidth,
                        r = a.clientHeight,
                        n = o.innerWidth,
        ...
        s({
            zoom: {
                ...
                zoomedSlideClass: "about-swiper-slide-zoomed"
            }
        }), t.zoom = {
            enabled: !1
        };
        ...
        function E(e) {
            const s = t.isElement ? "about-swiper-slide" : `.${t.params.slideClass}`;
        ...
        function x(e) {
            ...
            if (l = !1, d = !1, u.push(e), !(u.length < 2)) {
                if (l = !0, m.scaleStart = b(), !m.slideEl) {
                    m.slideEl = e.target.closest(`.${t.params.slideClass}, about-swiper-slide`), m.slideEl || (m.slideEl = t.slides[t.activeIndex]);
        ...
        function P(e) {
            const s = t.zoom,
                a = t.params.zoom;
            if (!m.slideEl) {
                e && e.target && (m.slideEl = e.target.closest(`.${t.params.slideClass}, about-swiper-slide`)), m.slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? m.slideEl = f(t.slidesEl, `.${t.params.slideActiveClass}`)[0] : m.slideEl = t.slides[t.activeIndex]);
        ...
        const w = (e, t, s) => {
            ...
            x = e => {
                ...
                const s = e.target.closest(`.${t.params.slideClass}, about-swiper-slide`);
            ...
            T = () => {
                ...
                const a = t.wrapperEl,
                    r = e.id || a.getAttribute("id") || `about-swiper-wrapper-${l=16,void 0===l&&(l=16),"x".repeat(l).replace(/x/g,(()=>Math.round(16*Math.random()).toString(16)))}`;
                var l;
        ...
        const y = () => {
            ...
            E = e => {
                ...
                const r = (() => {
                    let e;
                    if (e = i.virtual && i.params.virtual.enabled ? i.slides.filter((e => e.classList.contains("about-swiper-slide-active")))[0] : i.slides[i.activeIndex], !e) return;
        ...
        s({
            thumbs: {
                ...
                autoScrollOffset: 0,
                slideThumbActiveClass: "about-swiper-slide-thumb-active",
