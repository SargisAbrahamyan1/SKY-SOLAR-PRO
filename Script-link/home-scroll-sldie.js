    ...
    var H = {
        ...
        V = {
            ...
            onGestureStart: function(e) {
                ...
                s.$slideEl && s.$slideEl.length || (s.$slideEl = L(e.target).closest(".home-swiper-slide"), 0 === s.$slideEl.length && (s.$slideEl = t.slides.eq(t.activeIndex)), s.$imageEl = s.$slideEl.find("img, svg, canvas"), s.$imageWrapEl = s.$imageEl.parent("." + a.containerClass), s.maxRatio = s.$imageWrapEl.attr("data-swiper-zoom") || a.maxRatio, 0 !== s.$imageWrapEl.length) ? (s.$imageEl.transition(0), t.zoom.isScaling = !0) : s.$imageEl = void 0
            },
            ...
            enable: function() {
                ...
                if (!t.enabled) {
                    ...
                    te.gestures ? (e.$wrapperEl.on("gesturestart", ".home-swiper-slide", t.onGestureStart, a), e.$wrapperEl.on("gesturechange", ".home-swiper-slide", t.onGestureChange, a), e.$wrapperEl.on("gestureend", ".home-swiper-slide", t.onGestureEnd, a)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.on(e.touchEvents.start, ".home-swiper-slide", t.onGestureStart, a), e.$wrapperEl.on(e.touchEvents.move, ".home-swiper-slide", t.onGestureChange, a), e.$wrapperEl.on(e.touchEvents.end, ".home-swiper-slide", t.onGestureEnd, a)), e.$wrapperEl.on(e.touchEvents.move, "." + e.params.zoom.containerClass, t.onTouchMove)
                }
            },
            disable: function() {
                var e = this,
                ...
                if (t.enabled) {
                    ...
                    te.gestures ? (e.$wrapperEl.off("gesturestart", ".home-swiper-slide", t.onGestureStart, a), e.$wrapperEl.off("gesturechange", ".home-swiper-slide", t.onGestureChange, a), e.$wrapperEl.off("gestureend", ".home-swiper-slide", t.onGestureEnd, a)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.off(e.touchEvents.start, ".home-swiper-slide", t.onGestureStart, a), e.$wrapperEl.off(e.touchEvents.move, ".home-swiper-slide", t.onGestureChange, a), e.$wrapperEl.off(e.touchEvents.end, ".home-swiper-slide", t.onGestureEnd, a)), e.$wrapperEl.off(e.touchEvents.move, "." + e.params.zoom.containerClass, t.onTouchMove)
                }
            }
        },
        F = {
